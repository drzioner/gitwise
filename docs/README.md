...
- [Policy guard](reference/guard.md)
- [Migration guide (0.36)](MIGRATION-0.36.md)
...
- [Roadmap](../ROADMAP.md)
- [Language conventions](../LANGUAGE.md)
...
- [Python guidelines](guidelines/python-guidelines.md)
- [Testing guidelines](guidelines/testing-guidelines.md)
- [Anti-patterns](guidelines/anti-patterns.md)

## Historical docs

These are retained as historical analysis and planning snapshots:
